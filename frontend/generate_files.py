...
base_dir = r"c:\Users\mhmwd\Desktop\website\eltaisier\frontend\src"
...
# Vite config
vite_config_path = r"c:\Users\mhmwd\Desktop\website\eltaisier\frontend\vite.config.js"
...
# Placeholder Logo
logo_path = r"c:\Users\mhmwd\Desktop\website\eltaisier\frontend\public\assets\logo-placeholder.svg"
os.makedirs(os.path.dirname(logo_path), exist_ok=True)
with open(logo_path, "w", encoding="utf-8") as f:
    f.write('''<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
  <circle cx="50" cy="50" r="50" fill="#6C5CE7" />
  <text x="50" y="65" font-family="Arial" font-size="40" font-weight="bold" fill="white" text-anchor="middle">ET</text>
</svg>''')
